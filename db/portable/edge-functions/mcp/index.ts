...
var mcp_default = defineMcp({
  ...
  version: "0.1.0",
  instructions: "Read-only tools for the signed-in Quick USSD Dial user. Use these tools to inspect the user's profile, recent USSD unit transfers, registered devices, current license/trial status. All tools operate on the authenticated user's own data.",
