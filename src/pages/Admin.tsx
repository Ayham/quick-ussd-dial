...
import { Shield, LogOut, LayoutGrid, Users, Activity, FileText, Database } from "lucide-react";
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Operational console for users, transfers, and system events.</p>
            </div>
          </div>
